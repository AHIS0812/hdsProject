...
// 960×600 통일(OI-6) 이후 기준 — src/web/js/templates.js 의 main 프리셋과 같은 그리드(3카드 +
// 바로가기 + 최근 목록)를 쓰고, 이 케이스만의 업무 라벨(오늘 상담·대기·처리율·평균시간)을 얹는다.
const MAIN = [
  ['title', 30, 18, 300, 19, '영업 메인'],
  ['area', 30, 50, 290, 110, '요약 1'],
  ['label', 46, 78, 110, 15, '오늘 상담'],
  ['label', 170, 78, 100, 15, '0'],
  ['label', 46, 112, 110, 15, '대기'],
  ['label', 170, 112, 100, 15, '0'],
  ['area', 336, 50, 290, 110, '요약 2'],
  ['label', 352, 78, 110, 15, '처리율'],
  ['label', 476, 78, 100, 15, '0'],
  ['label', 352, 112, 110, 15, '평균시간'],
...
const CASES = [
  ...
  { id: 'N-MAIN', payload: { systemId: 'salesportal', systemName: '영업포탈', mode: 'new', template: 'main', screenName: '영업 메인', canvas: B(960, 600), shapes: shapesFrom(MAIN) } },
